<%-- 
    Document   : loginjsp
    Created on : 8 Feb, 2023, 11:46:26 AM
    Author     : student
--%>
...
<body>
    <section class="header">
        ...
        <div>
            ...
            <ul class="nav">
                ...
                <li> <a class="actives" href="newform.html">login </a></li>
    ...
    <form name="myform" method="POST" action="insert.jsp" onsubmit="return validationform();">
        <div class="container">
